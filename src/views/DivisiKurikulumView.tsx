    ...
    <div className="space-y-6 w-full text-left pb-12">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          >
            {programList.length === 0 ? (
              <option value="">Belum ada program (Buat di Kelola Divisi)</option>
            ) : (
      ...
      {programList.length === 0 ? (
        <div className="bg-white p-12 rounded-2xl border border-slate-200 shadow-sm text-center space-y-3">
          <h3 className="text-lg font-bold text-slate-800">Belum Ada Program Kegiatan untuk Divisi Kurikulum</h3>
          <p className="text-sm text-slate-500 max-w-md mx-auto">
            Silakan buka menu <span className="font-semibold text-blue-600">Kelola Divisi, IKU & Program</span> terlebih dahulu untuk menambahkan Divisi Kurikulum dan Program Kegiatannya (misal: Monitoring KBM).
          </p>
        </div>
      ) : (
        <>
